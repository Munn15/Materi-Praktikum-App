...
class ExpendableRecyclerAdapter (val modelList: List<Model>):
    RecyclerView.Adapter<ExpendableRecyclerAdapter.AdapterVH>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterVH {
        val view : View = LayoutInflater.from(parent.context).inflate(R.layout.item_expendable,parent,false)
